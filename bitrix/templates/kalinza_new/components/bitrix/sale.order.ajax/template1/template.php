...
<?
	...
	//	print_r($arResult);
	//	echo "</pre>";
	//		echo $arResult['PRICE_WITHOUT_DISCOUNT_VALUE'];

	if ($arResult['PRICE_WITHOUT_DISCOUNT_VALUE'] >= 1500){
echo '
				<div class=" " style="padding-top:30px; padding-bottom:30px;">
                    <div class="container container-fix">
                        <div class="row">
                            <div class="col-md-9 cfdfdf">
								Поздравляем у Вас <v style="color: #73d62a;">бесплатная</v> доставка. <img src="/2/images/delivery_icon.svg">
                            </div>
                        </div>
                    </div>
                </div>
	...
	$sumla = 1500 - $arResult['PRICE_WITHOUT_DISCOUNT_VALUE'];
echo '
				<div class=" " style="padding-top:30px; padding-bottom:30px;">
                    <div class="container container-fix">
                        <div class="row">
                            <div class="col-md-9 cfdfdf">
								Сделай заказ на '.$sumla.' рублей больше и получи <v style="color: #73d62a;">бесплатную</v> доставку. <img src="/2/images/delivery_icon.svg">
                            </div>
                        </div>
                    </div>
                </div>
...
?>
	...
	<form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
		...
		<div id="bx-soa-order" class="row bx-<?=$arParams['TEMPLATE_THEME']?> text40" style="opacity: 0">
			<!--	MAIN BLOCK	-->
			<div class="col-sm-9 bx-soa">
				...
				<div id="bx-soa-auth" class="bx-soa-section bx-soa-auth" style="display:none">
					<div class="bx-soa-section-title-container">
							<h2 class="bx-soa-section-title col-sm-9">
								<div class="laba bx-soa-section-title-count"></div>
								<div class="lala"><?=$arParams['MESS_AUTH_BLOCK_NAME']?></div>
							</h2> 
					</div>
				...
				<div id="bx-soa-region" data-visited="false" class="bx-soa-section bx-active bx-step-completed1" style="display:none !important;">
					<div class="bx-soa-section-title-container" style="display:none !important;">
							<h2 class="bx-soa-section-title col-sm-9" style="display:none !important;">
								<div class="laba bx-soa-section-title-count" style="display:none !important;"></div>
								<div class="lala" style="display:none !important;"><?=$arParams['MESS_REGION_BLOCK_NAME']?></div>
							</h2> 
						<div class="col-xs-12 col-sm-3 text-right" style="display:none !important;"><a href="" class="bx-soa-editstep"><?=$arParams['MESS_EDIT']?></a></div>
					</div>
					<div class="bx-soa-section-content container-fluid" style="display:none !important;"></div>
				</div>
				</div>
				...
				<? if ($arParams['DELIVERY_TO_PAYSYSTEM'] === 'p2d'): ?>
					...
					<div id="bx-soa-paysystem" data-visited="false" class="bx-soa-section bx-active">
						<div class="bx-soa-section-title-container">
							<h2 class="bx-soa-section-title col-sm-9">
								<div class="laba bx-soa-section-title-count"></div>
								<div class="lala"><?=$arParams['MESS_PAYMENT_BLOCK_NAME']?></div>
							</h2>  
					...
					<div id="bx-soa-delivery" data-visited="false" class="bx-soa-section bx-active" <?=($hideDelivery ? 'style="display:none"' : '')?>>
						<div class="bx-soa-section-title-container">
							<h2 class="bx-soa-section-title col-sm-9">
								<div class="laba bx-soa-section-title-count"></div>
								<div class="lala"><?=$arParams['MESS_DELIVERY_BLOCK_NAME']?></div>
							</h2>  
							<div class="col-xs-12 col-sm-3 text-right"><a href="" class="bx-soa-editstep"><?=$arParams['MESS_EDIT']?></a></div>
						</div>
						<div class="bx-soa-section-content container-fluid"></div>
				...
				<div id="bx-soa-pickup" data-visited="false" class="bx-soa-section" style="display:none;">
						<div class="bx-soa-section-title-container">
							<h2 class="bx-soa-section-title col-sm-9">
								<div class="bx-soa-section-title-count"></div> 
							</h2> 
							<div class="col-xs-12 col-sm-3 text-right"><a href="" class="bx-soa-editstep"><?=$arParams['MESS_EDIT']?></a></div>
						</div>
						<div class="bx-soa-section-content container-fluid"></div>
				...
				<div id="bx-soa-properties" data-visited="false" class="bx-soa-section bx-active">
					<div class="bx-soa-section-title-container">
							<h2 class="bx-soa-section-title col-sm-9">
								<div class="laba bx-soa-section-title-count"></div>
								<div class="lala"><?=$arParams['MESS_BUYER_BLOCK_NAME']?></div>
							</h2>  
						<div class="col-xs-12 col-sm-3 text-right"><a href="" class="bx-soa-editstep"><?=$arParams['MESS_EDIT']?></a></div>
					</div>
					<div class="bx-soa-section-content container-fluid"></div>
...
<div id="bx-soa-properties" data-visited="true" class="bx-soa-section bx-active bx-selected">
					<div class="bx-soa-section-title-container">
							<h2 class="bx-soa-section-title col-sm-9">
								<div class="laba bx-soa-section-title-count"></div>
								<div class="lala">Покупатель</div>
							</h2>  
						<div class="col-xs-12 col-sm-3 text-right"></div>
					</div>
					
<div class="bx-soa-section-content container-fluid"><div class="alert alert-danger" style="display: none;"></div>
<div class="row">
<div class="col-sm-12 bx-soa-customer">

<div class="form-group bx-soa-customer-field" >
<label for="soa-property-1" class="bx-soa-custom-label">Ваше имя и фамилия</label>
<div class="soa-property-container">
<input type="text" size="40" name="ORDER_PROP_1" 
 placeholder="Как к Вам обращаться" id="soa-property-1" autocomplete="name" 
	class="form-control bx-soa-customer-input bx-ios-fix" style="width:400px;">
</div>

</div><div class="form-group bx-soa-customer-field">
<label for="soa-property-2" class="bx-soa-custom-label">
E-Mail</label>
<div class="soa-property-container"><input type="text" size="40" name="ORDER_PROP_2" id="soa-property-2"  autocomplete="email" placeholder="Мы отправим всю информацию о заказе" class="form-control bx-soa-customer-input bx-ios-fix"  style="width:400px;"></div>
</div><div class="form-group bx-soa-customer-field" data-property-id-row="3">
...
<label for="soa-property-3" class="bx-soa-custom-label"><span class="bx-authform-starrequired">*</span> Телефон</label>
<div class="soa-property-container"><input type="text" size="30" name="ORDER_PROP_3" id="soa-property-3" autocomplete="tel" onkeyup="return proverka(this);" placeholder="Чтобы курьер мог с Вами связаться" class="form-control bx-soa-customer-input bx-ios-fix"  style="width:400px;"></div>
</div>

<div class="form-group bx-soa-customer-field" data-property-id-row="6">
<div class="soa-property-container">
<div class="bx-soa-loc">
<input type="hidden" id="LOCATION_ALT_PROP_DISPLAY_MANUAL[6]" name="LOCATION_ALT_PROP_DISPLAY_MANUAL[6]" value="0">
</div>
</div>
</div><div class="form-group bx-soa-customer-field" data-property-id-row="5">
<label for="soa-property-5" class="bx-soa-custom-label">Город</label>
<div class="soa-property-container">
<input type="text" size="40" name="ORDER_PROP_5" id="soa-property-5" placeholder="" 
class="form-control bx-soa-customer-input bx-ios-fix" value="<?
echo $_SESSION['ALTASIB_GEOBASE_CODE']['CITY']['NAME'];
?>" style="width:400px;">
</div>
</div>
<div class="form-group bx-soa-customer-field">
<label for="soa-property-7" class="bx-soa-custom-label">Куда доставить заказ?</label>
<div class="soa-property-container">
<textarea cols="30" rows="3" name="ORDER_PROP_7" id="soa-property-7" autocomplete="address" placeholder="" 
	class="form-control bx-ios-fix" style="width:400px; height:50px;"></textarea>
</div></div></div>




</div><div class="row bx-soa-more">
<div class="bx-soa-more-btn col-xs-12"></div></div></div></div>
				...
				<div style="display:none;">
					<div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active">
						<div class="bx-soa-section-title-container">
							<h2 class="bx-soa-section-title col-sm-9">
								<div class="laba bx-soa-section-title-count"></div>
								<div class="lala"><?=$arParams['MESS_BASKET_BLOCK_NAME']?></div>
							</h2>
							<div class="col-xs-12 col-sm-3 text-right"><a href="javascript:void(0)" class="bx-soa-editstep"><?=$arParams['MESS_EDIT']?></a></div>
						</div>
						<div class="bx-soa-section-content container-fluid"></div>
