                    ...
                    <div class="container container-fix">
                        <div class="row">
                            <div class="col-md-2">
                                ...
                                <div class="lk_href active2"><a href="/personal/orders/">История заказов</a></div>
                                <div class="lk_href"><a href="/personal/private/">Личные данные</a></div>
                            </div>
					...
					<div class="col-md-12 sale-order-list-inner-accomplished">
						<div class="row sale-order-list-inner-row">
							...
							<div class="col-md-3 col-md-offset-6 col-sm-12 sale-order-list-repeat-accomplished">
								<a class="btn btn-primary btn-send-message btn-md" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_COPY"])?>">
