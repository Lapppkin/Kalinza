(function () {
    ...
    BX.Sale.OrderAjaxComponentExt.getBlockFooter = function (node) {
        ...
        if (/bx-soa-auth|bx-soa-properties|bx-soa-region|bx-soa-paysystem|bx-soa-delivery|bx-soa-pickup|bx-soa-orderSave/.test(parentNodeSection.id)) {
    ...
    BX.Sale.OrderAjaxComponentExt.editOrder = function (section) {
        ...
        for (i in sections) {
            if (sections.hasOwnProperty(i)) {
                if (!(/bx-soa-auth|bx-soa-properties|bx-soa-region|bx-soa-paysystem|bx-soa-delivery|bx-soa-pickup|bx-soa-orderSave/.test(sections[i].id))) {
