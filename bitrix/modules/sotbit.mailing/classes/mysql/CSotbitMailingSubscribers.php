...
{  
    ...
    public function Delete($ID)
    {
        ...
        //удалим подписки для данного подписчика
    ...
    public function SubscribersAdd($arFields, $SETTING)
    {
        ...
        //получим все категории в которых есть подписчик
        //START
        ...
        if(is_array($subsInfo)) {
            //если нет настройки на удаление
            if($SETTING['ACTION_DELETE']!='NO_DELETE'){
                foreach($subsInfo as $k => $it) {
                    //если нет в массиве добавления категории удалим ее
            ...
            // уберем категории которые уже есть
    ...
    //удалить все категории подписчика
    ...
    //удалить все подписки связанные с категорией
    ...
    // удалить подписку по  подписчику и категории
    ...
    public function GetList($aSort=Array(), $arFilter=Array(), $arNavStartParams=false, $arSelect=Array())
    {
        ...
        // если идет выборка подписчиков по  категориям
        // START
