...
{       
    ...
    {
        if($apply!="")
            LocalRedirect("/bitrix/admin/sotbit_mailing_section_edit.php?ID=".$ID."&parent=".$parentID."&lang=".LANG);
        else
            LocalRedirect("/bitrix/admin/sotbit_mailing_list.php?parent=".$parentID."&lang=".LANG);
    }
    else
    {
