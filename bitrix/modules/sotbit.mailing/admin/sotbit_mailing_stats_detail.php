...
if(count($arrStaticInfo['STATICK_DATE_SEND_ELEMENT_COUNT']) == 1){
...
if(count($arrStaticInfo['STATICK_USER_OPEN_ELEMENT_COUNT']) == 1){
...
if(count($arrStaticInfo['STATICK_USER_BACK_ELEMENT_COUNT']) == 1){
...
if(count($arrStaticInfo['STATICK_ORDER']['STATICK_ORDER_MAILING']) == 1){
...
//������ 
if(count($arrStaticInfo['STATICK_COUPON']['COUPON_ELEMENT_ALL_DATE_COUNT']) == 1){
...
if(count($arrStaticInfo['STATICK_COUPON']['COUPON_ELEMENT_APPLY_DATE_COUNT']) == 1){
...
$lAdmin->BeginPrologContent();?>
    ...
    <h1><?=GetMessage($module_id.'_FILLTER_STATIC')?>
