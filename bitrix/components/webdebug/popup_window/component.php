...
if (!$bHasPath)
{
	...
	$arParams["AREA_FILE_SUFFIX"] = strlen($arParams["AREA_FILE_SUFFIX"]) > 0 ? $arParams["AREA_FILE_SUFFIX"] : "popup";
...
if ($bFileFound && CModule::IncludeModule('webdebug.popup')) {
	...
	$arResult['POPUP_PARAMS'] = array(
		...
		'CLOSE_TITLE' => $arParams['POPUP_CLOSE_TITLE'],
		'FIXED' => $arParams['POPUP_FIXED'],
		'MIDDLE' => $arParams['POPUP_MIDDLE'],
	...
	$arResult['POPUP_PARAMS']['AUTOOPEN_ONCE'] = $arParams['POPUP_AUTOOPEN_ONCE'];
	$arResult['POPUP_PARAMS']['AUTOOPEN_TERM'] = $arParams['POPUP_AUTOOPEN_TERM'];
	$arResult['POPUP_PARAMS']['AUTOOPEN_PATH'] = $arParams['POPUP_AUTOOPEN_PATH'];
	// Set default ID
