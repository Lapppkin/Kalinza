...
$MESS['SECTION_FIELDS'] = "Поля для показа";
$MESS['SECTION_NEAREST'] = "Ближайший город";
$MESS['ALTASIB_GEOBASE_UF_SHOW_COUNTY'] = "Показывать федеральный округ в списке полей";
$MESS['ALTASIB_GEOBASE_UF_SHOW_COORDINATES'] = "Показывать географические координаты в списке полей";
$MESS['SHOW_COORDINATES_TIP'] = "Будут показаны ширина и долгота избранного города";
$MESS['ALTASIB_GEOBASE_UF_FIND_NEAREST'] = "Выводить ближайший к избранному город, если не найдено точное совпадение";
$MESS['FIND_NEAREST_TIP'] = "Будет задействован поиск по координатам или региональному центру для автоматически определенного или заданного пользователем города.";
$MESS['ALTASIB_UF_NEAREST_MODE'] = "Режим поиска ближайшего города";
$MESS['ALTASIB_NMODE_GEO'] = "по координатам";
$MESS['ALTASIB_NMODE_REGION'] = "по региону";
$MESS['ALTASIB_NMODE_ALL'] = "по координатам и региону";
$MESS['ALTASIB_UF_NEAREST_USER_CHOICE'] = "Учитывать данные ручного выбора города при поиске ближайшего города";
?>