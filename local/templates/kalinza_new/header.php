...
<?$APPLICATION->IncludeComponent("altasib:geobase.select.city","",Array("LOADING_AJAX" => "Y","RIGHT_ENABLE" => "N","SMALL_ENABLE" => "N","SPAN_LEFT" => "","SPAN_RIGHT" => "Выберите город"));?>
...
if ($arData['CITY']['NAME']==''){echo '<a class="phone button_modal" href="tel:+78612921640">+7 861 292-16-40</a>';}
if ($arData['CITY']['NAME']!='' and $arData['CITY']['NAME']!='Краснодар' and $arData['CITY']['NAME']!='Ижевск' and $arData['CITY']['NAME']!='Новосибирск' and $arData['CITY']['NAME']!='Ставрополь' and $arData['CITY']['NAME']!='Железногорск' and $arData['CITY']['NAME']!='Шахты'){echo '<a class="phone button_modal" href="tel:+78612921640">+7 861 292-16-40</a>';}
if ($arData['CITY']['NAME']=='Краснодар'){echo '<a class="phone button_modal" href="tel:+78612921640">+7 861 292-16-40</a>';}
if ($arData['CITY']['NAME']=='Ижевск'){echo '<a class="phone button_modal" href="tel:+79641821029">+7 964 182-10-29</a>';}
if ($arData['CITY']['NAME']=='Новосибирск'){echo '<a class="phone button_modal" href="tel:+79607892123">+7 960 789-21-23</a>';}
if ($arData['CITY']['NAME']=='Ставрополь'){echo '<a class="phone button_modal" href="tel:+79283392421">+7 928 339-24-21</a>';}
if ($arData['CITY']['NAME']=='Железногорск'){echo '<a class="phone button_modal" href="tel:+79102717410">+7 910 271-74-10</a>';}
if ($arData['CITY']['NAME']=='Шахты'){echo '<a class="phone button_modal" href="tel:+79281657919">+7 928 165-79-19</a>';}
                                                ...
                                                <div class="row">
                                                    <div class="col-md-8 col-md-offset-2 col-md-pull-2 slider-text">
                                                        <div class="slider-text-inner">
                                                            ...
                                                            <p><a class="btn btn-primary btn-lg" href="/catalog/johnson_johnson/" style="z-index: 9999;position: relative;display: block; background: #15a0dc; color: #15a0dc; font-weight: bold;">Купить сейчас</a></p>
                                                        </div>
														<style>
  ...
  <div class="modal">
    ...
    <a class="close-modal">
      <svg viewBox="0 0 20 20">
        <path fill="#4ab8e6" d="M15.898,4.045c-0.271-0.272-0.713-0.272-0.986,0l-4.71,4.711L5.493,4.045c-0.272-0.272-0.714-0.272-0.986,0s-0.272,0.714,0,0.986l4.709,4.711l-4.71,4.711c-0.272,0.271-0.272,0.713,0,0.986c0.136,0.136,0.314,0.203,0.492,0.203c0.179,0,0.357-0.067,0.493-0.203l4.711-4.711l4.71,4.711c0.137,0.136,0.314,0.203,0.494,0.203c0.178,0,0.355-0.067,0.492-0.203c0.273-0.273,0.273-0.715,0-0.986l-4.711-4.711l4.711-4.711C16.172,4.759,16.172,4.317,15.898,4.045z"></path>
      </svg>
    </a><!-- close modal -->

    <div class="modal-contents TOLKO_MAIN">
      <table style="width: 100%; text-align: center;">
		  <tr><td><img src="/2/images/Logo.svg" width="80%"/></td></tr>
      </table>                                 
