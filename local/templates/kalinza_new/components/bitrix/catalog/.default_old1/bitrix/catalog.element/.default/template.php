                                                    ...
                                                    <div id="products">
                                                        ...
                                                        <ul class="pagination">
																<?
																		...
																		{
																?>
																	<li><a data-fancybox="gallery" href="<? echo $arOnePhoto['SRC']; ?>"><img src="<? echo $arOnePhoto['SRC']; ?>" width="55" alt="<? echo $arOnePhoto['ID']; ?>"></a></li>
																<?
																		}
unset($arOnePhoto);
																?>
...
if (!empty($URL)){echo '<li><a data-fancybox="gallery" id="f1" href="'.$URL.'"><img src="'.$URL.'" width="55" alt="'.$URL.'"></a></li>';}
$URL='';$ID_PICTYRE1='';
?>
<?
$URL2='';$ID_PICTYRE2='';
...
if (!empty($URL2)){echo '<li><a data-fancybox="gallery" id="f2" href="'.$URL2.'"><img src="'.$URL2.'" width="55" alt="'.$URL2.'"></a></li>';}
$URL2='';$ID_PICTYRE2='';
?>
<?
$URL3='';$ID_PICTYRE3='';
...
if (!empty($URL3)){echo '<li><a data-fancybox="gallery" id="f3" href="'.$URL3.'"><img src="'.$URL3.'" width="55" alt="'.$URL3.'"></a></li>';}
$URL3='';$ID_PICTYRE3='';
?>
<?
$URL4='';$ID_PICTYRE4='';
...
if (!empty($URL4)){echo '<li><a data-fancybox="gallery" id="f4" href="'.$URL4.'"><img src="'.$URL4.'" width="55" alt="'.$URL4.'"></a></li>';}
$URL4='';$ID_PICTYRE4='';
?>
<?
$URL5='';$ID_PICTYRE5='';
...
if (!empty($URL5)){echo '<li><a data-fancybox="gallery" id="f5" href="'.$URL5.'"><img src="'.$URL5.'" width="55" alt="'.$URL5.'"></a></li>';}
$URL5='';$ID_PICTYRE5='';
?>
<?
$URL6='';$ID_PICTYRE6='';
...
if (!empty($URL6)){echo '<li><a data-fancybox="gallery" id="f6" href="'.$URL6.'"><img src="'.$URL6.'" width="55" alt="'.$URL6.'"></a></li>';}
$URL6='';$ID_PICTYRE6='';
?>
                                                        </ul>
 														</div>
                                                        <div class="slides_container">
																<?
																		...
																		{
																?>
																	<a data-fancybox="gallery" href="<? echo $arOnePhoto['SRC']; ?>"><img src="<? echo $arOnePhoto['SRC']; ?>" width="366" alt="<? echo $arOnePhoto['ID']; ?>"></a>
																<?
																		}
unset($arOnePhoto);
																?>                
...
?>
													<div class="price_new"><div id="mydiv" style="float:left;"><? echo $arResult['PRICES']["BASE"]["VALUE"]; ?></div> ₽</div>
...
<?
			...
			{
?>
	<div><div><? echo $arResult['PROPERTIES'][$propID]['NAME']; ?></div>
	<div>
<?
				if(
...
if(CModule::IncludeModule("sale")){
	...
	while ($product = $products_in_cart->GetNext()) {
		...
		if (in_array("Подарок", $productnam)) {}else{
			if (CModule::IncludeModule("sale")){
			  $arFields = array(
				"PRODUCT_ID" => 577,
				"PRICE" => 0,
...
<!--
                                <table class="tovvaa2">
                                    <tr>
                                        <td>
                                            <div class="tovar">
                                                <img src="/2/images/1/image1.png" />
                                                <div class="none"></div>
                                                <p>1 Day Acuvue Define <br>Accent Style 90 Pack</p>
                                                <p class="par">10 пар</p>
                                                <div class="price">
                                                    <div class="price_old">2340.</div>
                                                    <div class="price_new">790.-</div>
                                                </div>
                                                <div class="bbb" style="margin: 0 auto;text-align: center;width: 100px;}">
...
-->
                            ...
                            <div class="col-md-2">
                                ...
                                <table class="tovvaa3">
                                    <tr>
                                        <td>
                                            <a href="whatsapp://+79182447228" target="_blank"><img src="/2/images/Whats_app.png"/></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <a href="viber://+79182447228" target="_blank"><img src="/2/images/viber.png"/></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
											<a href="https://www.instagram.com/optika_kalinza/" target="_blank"><img src="/2/images/Instagram.png"/></a>
                                        </td>
                                    </tr>
                                </table>
                            </div>
