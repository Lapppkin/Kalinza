...
<?
	...
	//	echo $arResult['PRICE_WITHOUT_DISCOUNT_VALUE']['BASKET_ITEMS'];


	if ($arResult['PRICE_WITHOUT_DISCOUNT_VALUE'] >= 1300){
echo '
				<div class=" " style="padding-top:30px; padding-bottom:30px; display:none;">
	...
	$sumla = 1300 - $arResult['PRICE_WITHOUT_DISCOUNT_VALUE'];
echo '
...
<script type="text/javascript">
	...
	//$('#soa-property-3').on('keyup keypress', function(e) {
$(document).ready(function() {
$('[name=ORDER_PROP_3]').bind("change keyup input click", function() {
		...
		<div id="bx-soa-order" class="row bx-<?=$arParams['TEMPLATE_THEME']?>" style="opacity: 0">
			...
			<div class="col-sm-9 bx-soa">
				...
				<? if ($arParams['BASKET_POSITION'] === 'after'): ?>
					<!--	BASKET ITEMS BLOCK	-->
				<div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active" style="display:none;">
						<div class="bx-soa-section-title-container">
							<h2 class="bx-soa-section-title col-sm-9">
								<span class="bx-soa-section-title-count"></span><?=$arParams['MESS_BASKET_BLOCK_NAME']?>
							</h2>
