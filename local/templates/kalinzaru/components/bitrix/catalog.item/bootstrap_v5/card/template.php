...
$resizeImg = \CFile::ResizeImageGet($item['PREVIEW_PICTURE']['ID'], ['width' => 200, 'height' => 9999], BX_RESIZE_IMAGE_PROPORTIONAL_ALT);
?>
<a href="<?= $item['DETAIL_PAGE_URL'] ?>" title="<?= $imgTitle ?>">
    <img src="<?= $resizeImg['src'] ?? $item['PREVIEW_PICTURE']['SRC'] ?>"/>
</a>
<p><a href="<?= $item['DETAIL_PAGE_URL'] ?>" title="<?= $imgTitle ?>" style="color:#000;"><?= $productTitle ?></a></p>
<?
