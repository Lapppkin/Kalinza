...
<div class="bx-catalog-element<?=$themeClass?>" id="<?=$itemIds['ID']?>" itemscope itemtype="http://schema.org/Product">
	...
	<div class="row">
		...
		?>
		<div class="<?=($showBlockWithOffersAndProps ? "col-md-5 col-lg-6" : "col-md-5"); ?>">
			<div class="row">
				<?
	...
	<!--Small Card-->
	<div class="p-2 product-item-detail-short-card-fixed" id="<?=$itemIds['SMALL_CARD_PANEL_ID']?>">
    ...
    <!--Top tabs-->
	<div class="pt-2 pb-0 product-item-detail-tabs-container-fixed" id="<?=$itemIds['TABS_PANEL_ID']?>">
		<ul class="product-item-detail-tabs-list">
			<?
			if ($showDescription)
			{
