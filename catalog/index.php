...
$APPLICATION->SetPageProperty("title", "Каталог товаров KALINZA");
$APPLICATION->SetTitle("");

if ($APPLICATION->GetCurDir() === '/catalog/') {
    // категории каталога
    $APPLICATION->IncludeFile('/' . $APPLICATION->GetCurDir() . 'root.php', array('config' => $config, 'iBlock' => CATALOG_DEFAULT_IBLOCK_ID));
} else {
